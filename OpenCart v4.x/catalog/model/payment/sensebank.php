<?php
namespace Opencart\Catalog\Model\Extension\Sensebank\Payment;
...
class Sensebank extends \Opencart\System\Engine\Model {
	...
	public function getMethods(array $address = []): array {
		...
		$option_data['sensebank'] = [
			'code' => 'sensebank.sensebank',
			'name' => $this->language->get('entry_sensebank_text_title')
		];
